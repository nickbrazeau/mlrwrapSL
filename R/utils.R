...
#' @param trained \code{WrappedModel}; A \code{mlr} learner that has been trained with \code{mlr::train} and results in a \code{WrappedModel}
#' @param task \code{Task}; A \code{mlr} task
#' @param subset <numeric vector>; A numeric vector of the rows in the \code{Task} data that should be used for training
